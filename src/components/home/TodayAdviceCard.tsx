  ...
  return (
    <div className="rounded-2xl border border-cyan-500/20 bg-white/[0.03] p-4">
      ...
      {advice.supportingNote && (
        <p className="mt-1 text-[11px] text-zinc-500">{advice.supportingNote}</p>
      )}
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          {advice.primaryAction && (
            <Link
              ...
              className="flex h-10 flex-1 min-w-[140px] items-center justify-center rounded-xl bg-cyan-500 px-4 text-xs font-bold text-black transition active:scale-[0.98]"
            >
          ...
          {advice.secondaryAction && (
            <Link
              ...
              className="flex h-10 flex-1 min-w-[140px] items-center justify-center rounded-xl border border-white/15 bg-white/5 px-4 text-xs font-semibold text-white transition active:bg-white/10"
            >
